...
19 проверок: догма (кнопки/цвета/иконки/типографика), синхронность `COMP_CSS`
с CSS-файлом, существование токенов и иконок, порядок загрузки (включая
скрытые зависимости демо-секций), смоук всех фабрик, целостность разметки.
