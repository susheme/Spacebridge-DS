...
- Используют его: `tooltips`, `info-footer`, `property-list`, `tabs`, `led-panel`, `cards`, `side-panel`
- Public API: `sbAntenna`, `sbMkStatusDot`, `sbMkBadgeStatus`, `sbMkMark`, `downloadAntennaZip`
- COMP_CSS: `status`
<!-- GEN:END -->
