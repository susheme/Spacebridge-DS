...
const NAV = [
  ...
  { category: 'Navigation', items: [
    { id: 'section-header', label: 'Header Section', inProgress: true },
    { id: 'header-xs', label: 'Header XS', inProgress: true },
    { id: 'header-s', label: 'Header S' },
    { id: 'modal-header', label: 'Header Modal' },
    { id: 'card-header', label: 'Header Card' },
    { id: 'header-l', label: 'Header L' },
  ...
  { category: 'Data Display', items: [
    ...
    { id: 'list', label: 'List', inProgress: true },
    { id: 'context-menu', label: 'Context Menu', inProgress: true },
    ...
    { id: 'tags', label: 'Tags', inProgress: true },
  ]},
  { category: 'Forms', items: [
    ...
    { id: 'selectors', label: 'Selectors / Dropdowns', inProgress: true },
...
function renderSidebar() {
  ...
  NAV.forEach(group => {
    ...
    group.items.forEach(item => {
      ...
      const dotCls = item.ready ? '' : item.inProgress ? 'in-progress' : 'coming';
      const badge = item.inProgress ? ' <span class="sb-badge sb-badge-alert">In Progress</span>' : '';
