...
.sb-sel-val { flex: 1; padding: 0 var(--pad-horiz-8); min-width: 0; font-size: var(--title-font-size-l); font-weight: var(--font-weight-regular); line-height: 1; color: var(--text-tertiary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }

.sb-sel-right { flex-shrink: 0; height: 100%; padding: var(--pad-vert-4) var(--pad-horiz-8); display: flex; align-items: center; justify-content: center; background: var(--surface-1); border-left: var(--border-width-1-5) solid var(--border); border-radius: 0 2px 2px 0; transition: border-color 0.15s, background 0.15s; }
