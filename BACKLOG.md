...
Правила стиля приняты 12.08.2026 и записаны в `CLAUDE.md`, раздел «Стиль текстов». Образец — Property List (`js/components/property-list.js`): и `description`, и Tech Info переписаны под них.
...
- 49 компонентов, у каждого `description` + `sbDocNote('Tech Info', …)`, оба языка.
