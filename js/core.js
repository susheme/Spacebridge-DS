...
const NAV = [
  ...
  { category: 'Navigation', items: [
    ...
    { id: 'side-panel', label: 'Side Panel', inProgress: true },
...
const ICON_PATHS = {
  ...
  // Side Navigation — Group иконки (закрытая/раскрытая/залитая) + row-actions
  // (pencil/delete). Пути из spacebridge-ds/Icons/ (source of truth, RemixIcon).
  'folder-line':      'M4 5V19H20V7H11.5858L9.58579 5H4ZM12.4142 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5Z',
  'folder-open-line': 'M3 21C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5H20C20.5523 5 21 5.44772 21 6V9H19V7H11.5858L9.58579 5H4V16.998L5.5 11H22.5L20.1894 20.2425C20.0781 20.6877 19.6781 21 19.2192 21H3ZM19.9384 13H7.06155L5.56155 19H18.4384L19.9384 13Z',
  'folder-fill':      'M12.4142 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5Z',
  'pencil-line':      'M15.7487 9.66775L14.3322 8.25122L5.00327 17.5802V18.9967H6.4198L15.7487 9.66775ZM17.1653 8.25122L18.5818 6.8347L17.1653 5.41816L15.7487 6.8347L17.1653 8.25122ZM7.24959 21H3V16.7504L16.457 3.29337C16.8482 2.90221 17.4824 2.90221 17.8735 3.29337L20.7066 6.12643C21.0978 6.51759 21.0978 7.1518 20.7066 7.54296L7.24959 21Z',
  'delete-bin-line':  'M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM18 8H6V20H18V8ZM9 11H11V17H9V11ZM13 11H15V17H13V11ZM9 4V6H15V4H9Z',
  ...
  // Filter / undo / save — выданы дизайнером 14.09.2026 (Icons/, RemixIcon).
  'filter-line': 'M21 3V5H20L15 12.5V21H9V12.5L4 5H3V3H21ZM6.4037 5L11 11.8944V19H13V11.8944L17.5963 5H6.4037Z',
  'arrow-go-back-line': 'M5.82843 7.94975L8.36396 10.4853L6.94975 11.8995L2 6.94975L6.94975 2L8.36396 3.41422L5.82843 5.94975H13C17.4183 5.94975 21 9.53147 21 13.9498C21 18.368 17.4183 21.9498 13 21.9498H4V19.9498H13C16.3137 19.9498 19 17.2635 19 13.9498C19 10.636 16.3137 7.94975 13 7.94975H5.82843Z',
  'save-line': 'M7 19V13H17V19H19V7.82843L16.1716 5H5V19H7ZM4 3H17L21 7V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3ZM9 15V19H15V15H9Z',
  'upload-cloud-2-line': 'M12 12.5858L16.2426 16.8284L14.8284 18.2426L13 16.415V22H11V16.413L9.17157 18.2426L7.75736 16.8284L12 12.5858ZM12 2C15.5934 2 18.5544 4.70761 18.9541 8.19395C21.2858 8.83154 23 10.9656 23 13.5C23 16.3688 20.8036 18.7246 18.0006 18.9776L18.0009 16.9644C19.6966 16.7214 21 15.2629 21 13.5C21 11.567 19.433 10 17.5 10C17.2912 10 17.0867 10.0183 16.8887 10.054C16.9616 9.7142 17 9.36158 17 9C17 6.23858 14.7614 4 12 4C9.23858 4 7 6.23858 7 9C7 9.36158 7.03838 9.7142 7.11205 10.0533C6.91331 10.0183 6.70879 10 6.5 10C4.567 10 3 11.567 3 13.5C3 15.2003 4.21241 16.6174 5.81986 16.934L6.00005 16.9646L6.00039 18.9776C3.19696 18.7252 1 16.3692 1 13.5C1 10.9656 2.71424 8.83154 5.04648 8.19411C5.44561 4.70761 8.40661 2 12 2Z',
  ...
  'draggable':             'M8.5 7C9.32843 7 10 6.32843 10 5.5C10 4.67157 9.32843 4 8.5 4C7.67157 4 7 4.67157 7 5.5C7 6.32843 7.67157 7 8.5 7ZM8.5 13.5C9.32843 13.5 10 12.8284 10 12C10 11.1716 9.32843 10.5 8.5 10.5C7.67157 10.5 7 11.1716 7 12C7 12.8284 7.67157 13.5 8.5 13.5ZM10 18.5C10 19.3284 9.32843 20 8.5 20C7.67157 20 7 19.3284 7 18.5C7 17.6716 7.67157 17 8.5 17C9.32843 17 10 17.6716 10 18.5ZM15.5 7C16.3284 7 17 6.32843 17 5.5C17 4.67157 16.3284 4 15.5 4C14.6716 4 14 4.67157 14 5.5C14 6.32843 14.6716 7 15.5 7ZM17 12C17 12.8284 16.3284 13.5 15.5 13.5C14.6716 13.5 14 12.8284 14 12C14 11.1716 14.6716 10.5 15.5 10.5C16.3284 10.5 17 11.1716 17 12ZM15.5 20C16.3284 20 17 19.3284 17 18.5C17 17.6716 16.3284 17 15.5 17C14.6716 17 14 17.6716 14 18.5C14 19.3284 14.6716 20 15.5 20Z',
  ...
  'notification-3-line': 'M20 17H22V19H2V17H4V10C4 5.58172 7.58172 2 12 2C16.4183 2 20 5.58172 20 10V17ZM18 17V10C18 6.68629 15.3137 4 12 4C8.68629 4 6 6.68629 6 10V17H18ZM9 21H15V23H9V21Z',
...
// S-иконки (16px) с СОБСТВЕННОЙ отрисовкой в viewBox 16 (Figma Icons/size-S).
// Имя есть здесь → S рендерится этим path'ом; нет → масштабом 24-грид path'а.
const ICON_PATHS_S = {
  'add-line': 'M7.42857 7.42857V4H8.57143V7.42857H12V8.57143H8.57143V12H7.42857V8.57143H4V7.42857H7.42857Z',
  'close-line': 'M7.99999 7.11114L11.1111 4L12 4.88889L8.88887 8.00003L12 11.1111L11.1111 12L7.99999 8.88891L4.88889 12L4 11.1111L7.11111 8.00003L4 4.88889L4.88889 4L7.99999 7.11114Z',
  'upload-cloud-2-line': 'M8 8.3907L10.8284 11.2191L9.8856 12.1619L8.66666 10.9435V14.6668H7.33333V10.9422L6.11438 12.1619L5.17157 11.2191L8 8.3907ZM8 1.3335C10.3956 1.3335 12.3696 3.13857 12.6361 5.4628C14.1905 5.88786 15.3333 7.31056 15.3333 9.00016C15.3333 10.9127 13.8691 12.4832 12.0004 12.6519L12.0006 11.3098C13.1311 11.1478 14 10.1754 14 9.00016C14 7.7115 12.9553 6.66683 11.6667 6.66683C11.5275 6.66683 11.3911 6.67903 11.2591 6.70283C11.3077 6.4763 11.3333 6.24122 11.3333 6.00016C11.3333 4.15922 9.84093 2.66683 8 2.66683C6.15905 2.66683 4.66666 4.15922 4.66666 6.00016C4.66666 6.24122 4.69225 6.4763 4.74136 6.70236C4.60887 6.67903 4.47252 6.66683 4.33333 6.66683C3.04466 6.66683 2 7.7115 2 9.00016C2 10.1337 2.80827 11.0784 3.8799 11.2895L4.00003 11.3099L4.00026 12.6519C2.1313 12.4836 0.666664 10.913 0.666664 9.00016C0.666664 7.31056 1.80949 5.88786 3.36432 5.4629C3.6304 3.13857 5.6044 1.3335 8 1.3335Z',
  // Filter / undo / save — выданы дизайнером 14.09.2026 (Icons/size-S, RemixIcon).
  'filter-line': 'M14 2V3.33333H13.3333L10 8.33333V14H6V8.33333L2.66667 3.33333H2V2H14ZM4.26913 3.33333L7.33333 7.9296V12.6667H8.66667V7.9296L11.7309 3.33333H4.26913Z',
  'arrow-go-back-line': 'M4.55229 4.9665L6.24264 6.65686L5.29983 7.59967L2 4.29983L5.29983 1L6.24264 1.94281L4.55229 3.63317H9.33333C12.2789 3.63317 14.6667 6.02098 14.6667 8.96653C14.6667 11.912 12.2789 14.2999 9.33333 14.2999H3.33333V12.9665H9.33333C11.5425 12.9665 13.3333 11.1757 13.3333 8.96653C13.3333 6.75736 11.5425 4.9665 9.33333 4.9665H4.55229Z',
  'save-line': 'M4.66667 12.6667V8.66667H11.3333V12.6667H12.6667V5.21895L10.7811 3.33333H3.33333V12.6667H4.66667ZM2.66667 2H11.3333L14 4.66667V13.3333C14 13.7015 13.7015 14 13.3333 14H2.66667C2.29848 14 2 13.7015 2 13.3333V2.66667C2 2.29848 2.29848 2 2.66667 2ZM6 10V12.6667H10V10H6Z',
};
...
function sbIcon(name, size = 'L') {
  const s = iconPx(size);
  const d16 = s === 16 ? ICON_PATHS_S[name] : undefined;
  const d = d16 || ICON_PATHS[name];
  const vb = d16 ? 16 : 24;
  if (!d) return `<span class="sb-icon-wrap" style="width:${s}px;height:${s}px;display:inline-block;"></span>`;
  return `<span class="sb-icon-wrap"><svg width="${s}" height="${s}" viewBox="0 0 ${vb} ${vb}" fill="currentColor" style="display:block;"><path d="${d}"/></svg></span>`;
}
...
function sbIconRaw(name, size = 'L') {
  ...
  const d = d16 || ICON_PATHS[name];
  const vb = d16 ? 16 : 24;
  return `<svg width="${s}" height="${s}" viewBox="0 0 ${vb} ${vb}" fill="currentColor"><path d="${d}"/></svg>`;
}
